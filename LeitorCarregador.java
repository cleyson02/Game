...
public class LeitorCarregador {
        ...
        try {
            ...
            while (escaneadorArquivoCapitulos.hasNextLine()) {
                ...
                if (linhaEscaneada.equals("CAPITULO_COM_IMAGEM")) {
                    CapituloImagem capitulo = new CapituloImagem(personagens, escaneadorArquivoCapitulos);
                    capitulos.put(capitulo.getTitulo(), capitulo);
                    linhaEscaneada = "";
                }

                if (linhaEscaneada.equals("CAPITULO")) {
                    Capitulo capitulo = new Capitulo(personagens, escaneadorArquivoCapitulos);
                    capitulos.put(capitulo.getTitulo(), capitulo);
                    linhaEscaneada = "";
                }
    ...
    private void lerEscolha(HashMap<String, Capitulo> capitulos, Scanner escaneadorArquivoCapitulos) {
        ...
        escaneadorArquivoCapitulos.nextLine(); // CAPITULO DE ORIGEM
        ...
        escaneadorArquivoCapitulos.nextLine(); // CAPITULO DE DESTINO
